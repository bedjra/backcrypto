...
class Transaction(db.Model):
    ...
    montant_USDT = db.Column(db.Numeric(12, 2), nullable=False)  # Deux chiffres après la virgule
...
class Fournisseur(db.Model):
    ...
    quantite_USDT = db.Column(db.Numeric(12, 2), nullable=False)  # Deux chiffres après la virgule
...
class Beneficiaire(db.Model):
    ...
    commission_USDT = db.Column(db.Numeric(12, 2), nullable=False)  # Deux chiffres après la virgule
